...
import styles from './SoftwareCatalogue.module.scss';
import * as strings from 'softwareCatalogueStrings';
import { ISoftwareCatalogueWebPartProps } from './ISoftwareCatalogueWebPartProps';

import * as angular from 'angular';
import './app/app-module';

export default class SoftwareCatalogueWebPart extends BaseClientSideWebPart<ISoftwareCatalogueWebPartProps> {

  public render(): void {
    if (this.renderedOnce === false) {
      this.domElement.innerHTML = `
<div class="${styles.toDoWebPart}">
  <div data-ng-controller="CatalogueController as vm">
